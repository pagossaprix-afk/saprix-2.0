                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                              ...
                              <div className="space-y-3">
                                ...
                                <div className="space-y-1">
                                  ...
                                  <a href="https://wa.me/573019086637" target="_blank" rel="noopener noreferrer" className="group flex items-center gap-3 p-2 rounded-lg hover:bg-green-50 dark:hover:bg-green-900/20 transition-all" onClick={() => close()}>
